...
debugLog('module-load: src/embeddings/hf-metadata/index.ts');
...
import { fetchJson, HF_BASE, HF_API, ONNX_FILE_BY_DTYPE } from './http.js';
import type { ConfigJson, SentenceTransformersModule, HfTreeFile, DenseConfig } from './internal-types.js';
