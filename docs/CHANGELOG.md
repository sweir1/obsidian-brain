...
- **Tests** — 4 new test files covering each layer with mocked fetch + in-memory DB (35 new test cases at original ship; +2 cases later for the v1→v2 seed adapter). Existing tests updated for the call-site changes. Total 827/827 passing at end of v1.7.5 work.
